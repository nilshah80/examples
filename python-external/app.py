...
def run_cli():
    ...
    print(f"{YELLOW}{BOLD}  ║  Identity Service — External Client (Python)     ║{RESET}")
    print(f"{YELLOW}{BOLD}  ║  Auth: HMAC-SHA256 + AES-256-GCM                 ║{RESET}")
    print(f"{YELLOW}{BOLD}  ║  Client: {client_id:<40} ║{RESET}")
    print(f"{YELLOW}{BOLD}  ╚══════════════════════════════════════════════════╝{RESET}")
    print()
    ...
    print(f"{CYAN}{BOLD}  ── Step 2: Token Issue (HMAC-SHA256 + GCM) ──{RESET}")
