...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'WASM computes HMAC-SHA256 signature over plaintext body, then encrypts with AES-256-GCM. Issues access + refresh tokens.',
...
async function step2() {
  ...
  // Order fields alphabetically to match Rust's serde_json serialization
  // Top-level: audience, custom_claims, include_refresh_token, scope, single_session, subject
  // Nested custom_claims: partner_id, region (alphabetical)
  const requestBody = {
    audience: 'orders-api',
  ...
  // Compute HMAC-SHA256 signature over PLAINTEXT body (before encryption)
  ...
  const requestHeaders = {
    ...
    'X-Signature': signature  // HMAC signature (External Client)
  };
