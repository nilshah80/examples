...
export class AppComponent implements OnInit {
  title = 'Identity Service — Rust WASM Angular (External Partner)';
  loading = true;
  ...
  steps: Step[] = [
    ...
    {
      n: 2,
      title: 'Token Issue (HMAC Signature + GCM)',
      desc: 'WASM computes HMAC-SHA256 signature over plaintext body, then encrypts with AES-256-GCM. Returns access + refresh tokens.',
