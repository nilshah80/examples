...
const _steps = [
  ...
  _StepDef(
    ...
    'Encrypt request body with AES-256-GCM and authenticate via '
        'Authorization: Basic. Issues access + refresh tokens.',
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            // Header
            Text(
              'Identity Service — Internal Client',
            ...
            Text(
              'OAuth2 Token Flow with AES-256-GCM Encryption (Basic Auth)',
            ...
            Padding(
              ...
              child: Text(
                'Auth: Basic Auth  •  Crypto: Dart (on-device)  •  Client: ${AppConfig.clientId}',
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
