...
func main() {
	...
	fmt.Println()
	fmt.Println("  Identity Service — Internal Client Example (Go)")
	fmt.Printf("  Web UI:  http://localhost:%d\n", config.Port)
	fmt.Println("  API:     /steps/1..6 → Go crypto → Sidecar")
	fmt.Println("  Auth:    Basic Auth")
	fmt.Println()
...
func runCLI(config Config) {
	...
	fmt.Println()
	fmt.Printf("%s%s  ╔══════════════════════════════════════════════════╗%s\n", BLUE, BOLD, RESET)
	fmt.Printf("%s%s  ║  Identity Service — Internal Client (Go)         ║%s\n", BLUE, BOLD, RESET)
	fmt.Printf("%s%s  ║  Auth: Basic Auth + AES-256-GCM                  ║%s\n", BLUE, BOLD, RESET)
	fmt.Printf("%s%s  ║  Client: %-40s ║%s\n", BLUE, BOLD, clientID, RESET)
	fmt.Printf("%s%s  ╚══════════════════════════════════════════════════╝%s\n", BLUE, BOLD, RESET)
	fmt.Println()
	...
	// Step 2: Token Issue
	fmt.Printf("%s%s  ── Step 2: Token Issue (Basic Auth + GCM) ──%s\n", CYAN, BOLD, RESET)
